...
import { CoGovermentTypeService } from './../../data/services';

@Component({
  selector: 'app-co-goverment-types',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './CoGovermentTypes.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export default class CoGovermentTypesComponent implements OnInit {
  // injectors
  coGovermentTypeService = inject(CoGovermentTypeService);
  ...
  onCreateNewPopulation(): void {
    ...
    if (this.newPopulationTypeForm.valid) {
      ...
      this.coGovermentTypeService.addNewCoGovermentType(
      ...
      this.messageService.add({
        ...
        detail: 'Tipo de Co-Gobierno creado con éxito',
      });
      // toggle the dialog
      this.toggleDialog();
    } else {
